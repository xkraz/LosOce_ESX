...
function getPlayers()
	...
	for _,i in ipairs(GetActivePlayers()) do
		local iPlayerID = GetPlayerServerId(i)
		local iPlayer = GetPlayerFromServerId(iPlayerID)
		
		if NetworkIsPlayerActive(iPlayer) then
			table.insert(players, {id = iPlayerID, name = GetPlayerName(iPlayer)})
		end
	end
	return players
end